...
jQuery(async () => {
    ...
    // NEW: /scene slash command implementation
    registerSlashCommand("scene", (args) => {
        ...
        // Score the characters based on their actions
        const scores = {};
        allMatches.forEach(match => {
        ...
        // Any character with at least 40% of the top score is considered primary
