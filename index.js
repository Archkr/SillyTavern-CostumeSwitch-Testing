...
jQuery(async () => {
    ...
    function tryWireUI() {
        ...
        $("#cs-profile-save").off('click.cs').on("click.cs", () => {
            ...
            // PATCH: Do not delete old profile when name changes. This creates a duplicate instead of renaming.
            // if (newName !== oldName) {
